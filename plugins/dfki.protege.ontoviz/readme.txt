...
1. Unzip ontoviz.jar and grappa1_2.jar into the Protege "plugins" subdirectory.
   Make sure to preserve the path information provided in the ZIP file so that the
   proper subdirectory is created under the "plugins" subdirectory.

   IMPORTANT: If you have a previous version of OntoViz installed, you have to 
   remove ontoviz-1.X.jar!)

2. Install the Graphviz tool 
   - Download the appropriate version of Graphviz for your platform from:
